...
export default function DiaryFavCardPage(props) {
	...
	const [addedBox, setAddedBox] = useState(<WantedTeaForm />)
	...
	function tastedTea() {
		if(!props.user.isPremium && props.user.tastedTeasObj.length + props.user.wantedTeasObj.length >= 5) {
	...
	return (
		<div className="cardPage_blur_wrapper" onLoad={scrollPos}>	
			...
			<div className="cardPage_container">
				...
				<div className="cardPage_teaPicture_block"><div className="cardPage_teaPicture_shape"><img draggable="false" src={props.teaObj.teaImgPath} alt="tea img" /></div></div>
				...
				<div className="cardPage_tabs_section">
					...
					<div className="tea_info">
						<p className="tea_notation captionOne-font">{props.teaObj.teaDescription}</p>
